...
{{--    <a href="{{ route('admin.add', ['status' => 'nav']) }}" type="button" class="btn btn-primary rounded-3">Add New Game</a>--}}
    ...
    <table class="table table-hover mt-2">
        ...
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.accountEdit', ['id' =>$data->id_c] ) }}" type="button"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.accountActivate', $data1->id_c) }}">
                                    @csrf
                                    <div class="modal-body">
                                        Are you sure want to Re-ACTIVATE this account?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Cancel</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.accountDelete', $data1->id_c) }}">
                                    @csrf
                                    <div class="modal-body">
                                        Are you sure want to PERMANENT DELETE this account?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Cancel</button>
