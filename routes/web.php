...
Route::group(['middleware','check.login'],function() {
    ...
    Route::get('account/{id}', [AdminController::class, 'viewEditAccount'])->name('admin.accountEdit');
    Route::post('/accountUpadte/{id}', [AdminController::class, 'updateAccount'])->name('admin.accountUpdate');
